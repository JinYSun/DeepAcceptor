...
## <u>Demo</u>
 ...
 The [example.ipynb](https://github.com/JinYSun/DeepAcceptor/blob/master/abcBERT/Demo/example.ipynb) was used to show the whole process of abcBERT. The files in Demo were used to test that the codes work well. All parameters were set **small** (such as epochs, dataset size) to show how the abcBERT worked.
